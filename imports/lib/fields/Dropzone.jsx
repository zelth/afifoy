    ...
    return (
      <div>
        ...
        <div style={{ position: 'relative', marginBottom: 10 }}>
          {showImage && value && <div>{fileName}</div>}
        ...
        {progress > 0 && progress < 100 ?
          ...
          (
            <Dropzone
              ...
              {...this.passProps}
            >
              <div className="center orange-text">This dropzone accepts only word document and pdf files. <br /> Try dropping some here, or click to select files to upload.</div>
