...
class EmployerSignup extends React.Component {
  ...
  onSubmit(user) {
    Meteor.call('registerEmployer', user, (err) => {
      if (err) {
          ...
          <div className="row center">
            ...
            <div className="col s6">
              <div className="section">
                <div>
                  <div className="row">
                    <h3 className="orange-text col s12">Employer Registration</h3>
                    <p className="header col s12 light">Create Job Post and Manage applicants / job seeker</p>
                    <Form collection={User} onSubmit={this.onSubmit}>
                      <Field fieldName="companyName" name="companyName" type={Text} autoComplete="off" label="Company Name" required />
...
EmployerSignup.childContextTypes = {
