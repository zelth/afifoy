      ...
      <div className={job.isFeatured ? 'card-panel lime lighten-3 scale-transition' : 'card-panel scale-transition'}>
        <div className="row margin-0">
          ...
          <div className="col s1">
            <ul>
              <li><a className="btn-floating yellow darken-1" href={FlowRouter.path('adminJobPublish', { jobId: job._id })}><i className="material-icons">view_quilt</i></a></li>
        ...
        <div className="row margin-0">
          ...
          <div className="col s5 light right-align">
              Applicants : <strong>{job.stats.completed}</strong>
          </div>
